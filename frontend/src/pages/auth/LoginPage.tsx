  ...
  return (
    ...
    >
      <div className="w-full max-w-6xl overflow-hidden rounded-[28px] bg-[#f8f8f8] border border-[#e7e1da] grid grid-cols-1 lg:grid-cols-2">
        ...
        <div className="p-4">
          <div className="relative h-full min-h-[600px] rounded-[24px] overflow-hidden">
            <img 
            ...
            <div className="relative z-10 h-full flex flex-col justify-between p-8">
              ...
              <div className="max-w-sm">
                ...
                <h2 className="text-4xl leading-tight font-bold text-white" style={{ fontFamily: "var(--font-primary)" }}>
                  Selamat Datang Kembali di Layanan Digital Kami.
                </h2>
              </div>
            </div>
          </div>
          ...
          <div className="w-full max-w-md">
            <div className="mb-8">
              ...
              <p className="mt-3 text-sm leading-relaxed font-inter-medium" style={{ color: "var(--color-moss-drab)" }}>
                Masuk ke akun TIDUR+ kamu untuk menikmati layanan penuh
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <Button type="submit" className="w-full h-12 rounded-xl text-white font-semibold transition-all hover:opacity-90 mt-2" style={{ backgroundColor: "var(--color-sun-glow)" }}>
            ...
            <div className="mt-7 text-center text-sm">
              <span style={{ color: "var(--color-moss-drab)" }}>Belum punya akun?</span>{" "}
              <Link to="/register" className="font-semibold hover:underline" style={{ color: "var(--color-sun-burn)" }}>
                Daftar di sini
              </Link>
            </div>
          </div>
