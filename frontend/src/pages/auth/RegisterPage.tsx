          ...
          <div className="w-full max-w-md">
            <div className="mb-8">
              <h2
                ...
                style={{ fontFamily: "var(--font-primary)", color: "var(--color-clay-coffee)" }}
              >
                Daftar Anggota
              </h2>
              <p
                className="mt-3 text-sm leading-relaxed font-inter-medium"
                style={{ color: "var(--color-moss-drab)" }}
              >
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="space-y-2">
                <Label
                  htmlFor="nik"
                  className="text-sm"
                  style={{ color: "var(--color-clay-coffee)" }}
                >
                  NIK
                </Label>
                <Input
                  ...
                  className="h-12 rounded-xl border-[#ddd6ce] bg-white focus-visible:ring-0 focus-visible:border-[#eb6935]"
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    onChange={handleChange}
                    className="h-12 pr-11 rounded-xl border-[#ddd6ce] bg-white focus-visible:ring-0 focus-visible:border-[#eb6935]"
                  />
                  <button
                    type="button"
                  ...
                  >
                    {showPassword ? (
                      <EyeOff className="w-4 h-4 text-[#6b645d]" />
                    ) : (
                      <Eye className="w-4 h-4 text-[#6b645d]" />
                    )}
                  </button>
                </div>
              </div>
              ...
              <div className="space-y-2">
                <Label className="text-sm" style={{ color: "var(--color-clay-coffee)" }}>
                  Jenis Kelamin
                </Label>
                <Select
              ...
              <div className="space-y-2">
                ...
                <label
                  htmlFor="photo"
                  className="h-28 rounded-xl border border-dashed border-[#ddd6ce] bg-white flex flex-col items-center justify-center cursor-pointer"
                >
              ...
              <Button
                type="submit"
                className="w-full h-12 rounded-xl text-white font-semibold transition-all hover:opacity-90"
              ...
              <div className="relative my-4">
                ...
                <div className="relative flex justify-center text-xs uppercase">
                  <span className="bg-[#f8f8f8] px-2 text-gray-400">Atau</span>
                </div>
              </div>
              ...
              >
                <svg className="w-5 h-5 mr-2" viewBox="0 0 24 24">
                  <path
                    fill="#EA4335"
                    d="M12 5.04c1.64 0 3.12.56 4.28 1.67l3.2-3.2C17.52 1.58 15 1 12 1 7.35 1 3.4 3.65 1.45 7.5l3.85 3C6.25 7.42 8.9 5.04 12 5.04z"
                  />
                  <path
                    fill="#4285F4"
                    d="M23.5 12.25c0-.82-.07-1.6-.2-2.35H12v4.5h6.46c-.28 1.47-1.12 2.7-2.38 3.55l3.7 2.88c2.16-2 3.72-4.94 3.72-8.58z"
                  />
                  <path
                    fill="#FBBC05"
                    d="M5.3 14.5c-.25-.75-.4-1.55-.4-2.5s.15-1.75.4-2.5L1.45 6.5C.53 8.35 0 10.1 0 12s.53 3.65 1.45 5.5l3.85-3z"
                  />
                  <path
                    fill="#34A853"
                    d="M12 23c3.24 0 5.97-1.08 7.96-2.92l-3.7-2.88c-1.03.7-2.33 1.12-4.26 1.12-3.1 0-5.75-2.38-6.7-5.46l-3.85 3C3.4 20.35 7.35 23 12 23z"
                  />
                </svg>
            ...
            <div className="mt-7 text-center text-sm">
              ...
              <Link
                ...
                style={{ color: "var(--color-sun-burn)" }}
              >
                Masuk sekarang
              </Link>
            </div>
